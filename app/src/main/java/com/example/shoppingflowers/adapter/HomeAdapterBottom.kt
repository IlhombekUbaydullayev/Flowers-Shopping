...
class HomeAdapterBottom(var context: Context, private var items: ArrayList<MemberCenter>) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_home_bottom_layout, parent, false)
